"""Train a Stable Diffusion 1.5 or SDXL ControlNet model."""
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default="0",
        help="指定使用的GPU ID，例如 '0' 表示使用第一个GPU，'0,1' 表示使用多个GPU"
    )
    parser.add_argument(
        "--resolution",
        type=int,
...
def prepare_train_dataset(dataset, accelerator):
    ...
    def preprocess_train(examples):
        ...
        conditioning_image_paths = [Path(args.train_data_dir) / image_path for image_path in
                                    examples[args.conditioning_image_column]]
...
def main(args):
    ...
    if accelerator.is_main_process:
        ...
        if loss_history and step_history:
